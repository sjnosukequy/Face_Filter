...
def Bat_Filter(image):
    ...
    angle = (face_landmarks_list[0]['right_eye'][0][1] - face_landmarks_list[0]['left_eye'][0][1]) / (face_landmarks_list[0]['right_eye'][0][0] - face_landmarks_list[0]['left_eye'][0][0])
